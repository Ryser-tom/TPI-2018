...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 08 mai 2018 à 14:39
...
CREATE TABLE IF NOT EXISTS `categories` (
  ...
  KEY `fk_categories_type_categories1_idx` (`type_categories_idTypeCategorie`)
...
CREATE TABLE IF NOT EXISTS `type_categories` (
  `idTypeCategorie` int(11) NOT NULL,
...
INSERT INTO `utilisateurs` (`idutilisateur`, `nom`, `prenom`, `dateNaissance`, `natel`, `Email`, `Mdp`) VALUES
(1, 'ryser', 'tom', '1998-03-03', '0798380065', 'tom.rsr@eduge.ch', '52d166edfc5ee6a6413333ea67be0eb40d467a72'),
(2, 'nikxla', 'nikola', '1998-04-30', '0893111565', 'nikola.antnj@eduge.ch', '52d166edfc5ee6a6413333ea67be0eb40d467a72'),
(3, 'djokovic', 'damjan', '1998-04-22', '04813461570', 'damjan.jvnvc@eduge.ch', '52d166edfc5ee6a6413333ea67be0eb40d467a72'),
(4, 'ryry', 'tomtom', '1998-03-03', '+41798380069', 'tom.rsr@eduge.ch', '52d166edfc5ee6a6413333ea67be0eb40d467a72');
...
INSERT INTO `vehicules` (`idVehicule`, `immatriculation`, `marque`, `modele`, `nbPlace`, `couleur`, `image`, `dateDebutDisponibilite`, `dateFinDisponibilite`, `categories_idcategorie`, `utilisateurs_idutilisateur`) VALUES
(1, 'GE 999 999', 'audi', 'R8', 2, 'rouge', 'image', '2018-04-10', NULL, 1, 1),
(2, 'GE 123 123', 'Yamaha', 'Fz6n', 2, 'noir', 'image', '2018-04-10', '2018-04-30', 14, 1),
(3, 'GE 123 321', 'Yamaha', 'Fz6n', 2, 'noir', 'image', '2018-04-01', '2018-05-05', 14, 1),
(4, 'GE 321 321', 'Yamaha', 'Fz6n', 2, 'noir', 'image', '2018-03-01', '2018-05-10', 14, 1),
(5, 'GE 999 999', 'audi', 'R8', 2, 'rouge', 'image', '2018-05-08', NULL, 1, 1),
(6, 'GE 456 789', 'Audi', 'R8', 2, 'Orange', 'image', '2018-05-08', NULL, 1, 2);
